...
const {users:{user:{_id}},swExtra:{swExtra:{bankDetails}}} = useSelector((state:RootState)=>state)
const [initialValues,setInitialValues] = useState<BankDetails>(bankDetails)
          ...
          if(_id){
              formikHelpers.validateForm().then(async (data:any)=>{
                const snackbarParams: SnackBarParams = {
                  ...
                  const msg = await bankDetailsSubmitHandler(_id,values,router,snackbarParams)
