        ...
        <Container sx={{ mt: "1rem" }}>
          ...
          <ol>
            ...
            <li>
              ...
              job, loss of money, dissatisfaction, and disappointment on the
              part of individuals requiring one service or the other to be
              provided for them.
            </li>
          </ol>
          Furthermore, the company is committed to adequately curbing the number
          of unemployed people in Nigeria and as well, growing the skilled
          worker space. A situation whereby skilled individuals do not
          necessarily have to go out in search of jobs, but can find jobs easily
          online, like freelancers or individuals with digital skills. The
          company aims to be a global working online platform for all skilled
          individuals looking to take advantage of a platform that provides easy
          access to employers/those in demand of their skill set.
        </Container>
      </main>
    </Layout>
  );
