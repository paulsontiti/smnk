    ...
    <Accordion>
      ...
      >
        ...
        >
            ...
            {report.read ? <MarkChatReadIcon color="success"/> : <MarkChatUnreadIcon color="warning"/>}
            </>
...
{report.correction.subject && <SWCorrectionDetailsAccordion reportId={report._id} jobId={jobId} correction={report.correction}/>}
