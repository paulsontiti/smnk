...
const createRow=(profile:any)=>{
    const row:any[] = [
        createData('Company Name',profile.name),
        createData('Company Email',profile.email),
        createData('Company Phone',profile.phone),
        createData('State',profile.state),
        createData('L.G.A',profile.lga),
        createData('Address',profile.officeAddress),
...
export default function SwCompanyProfileDetailsTable({profile}:{profile:any}) {
  return (
